...
namespace Amptron.ViewModels.Menu
{
	public partial class DeviceInfoViewModel : TabViewModelBase
	{
        ...
        {
            Device = new BluetoothDevice() { DeviceId = Guid.NewGuid(), DeviceModel = "NEX001", DeviceName = "NEX001", NoOfCycles = 100, BluetoothId = Guid.NewGuid(), Version = "965234684133", ProtocolVersion = "242342", Protocol = "Modbus TCP", LastUpdated = DateTime.Now, Status = "Active", SNCode = "123214214" };
        }
